...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { ar_an2_p }]; #IO_L20P_T3_AD6P_35 Sch=ar_an2_p
...
set_property IOSTANDARD LVCMOS33 [get_ports crank_raw]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports cam_raw]

set_property PACKAGE_PIN T14 [get_ports crank_raw]
set_property PACKAGE_PIN U12 [get_ports cam_raw]
set_property PACKAGE_PIN U13 [get_ports {digital_inputs[0]}]
set_property PACKAGE_PIN V13 [get_ports {digital_inputs[1]}]
set_property PACKAGE_PIN V15 [get_ports {digital_inputs[2]}]
set_property PACKAGE_PIN T15 [get_ports {digital_inputs[3]}]
set_property PACKAGE_PIN R16 [get_ports {digital_inputs[4]}]
set_property PACKAGE_PIN U17 [get_ports {digital_inputs[5]}]
set_property PACKAGE_PIN V17 [get_ports {digital_inputs[6]}]
set_property PACKAGE_PIN V18 [get_ports {digital_inputs[7]}]

#connect_debug_port u_ila_0/clk [get_nets [list xadc_dclk_OBUF_BUFG]]
#connect_debug_port u_ila_0/probe0 [get_nets [list {xadc_do_IBUF[0]} {xadc_do_IBUF[1]} {xadc_do_IBUF[2]} {xadc_do_IBUF[3]} {xadc_do_IBUF[4]} {xadc_do_IBUF[5]} {xadc_do_IBUF[6]} {xadc_do_IBUF[7]} {xadc_do_IBUF[8]} {xadc_do_IBUF[9]} {xadc_do_IBUF[10]} {xadc_do_IBUF[11]} {xadc_do_IBUF[12]} {xadc_do_IBUF[13]} {xadc_do_IBUF[14]} {xadc_do_IBUF[15]}]]
#connect_debug_port u_ila_0/probe1 [get_nets [list {raw_angle[0]} {raw_angle[1]} {raw_angle[2]} {raw_angle[3]} {raw_angle[4]} {raw_angle[5]} {raw_angle[6]} {raw_angle[7]} {raw_angle[8]} {raw_angle[9]} {raw_angle[10]} {raw_angle[11]} {raw_angle[12]}]]
#connect_debug_port u_ila_0/probe2 [get_nets [list {u_sync/ab_count_reg[0]} {u_sync/ab_count_reg[1]} {u_sync/ab_count_reg[2]} {u_sync/ab_count_reg[3]} {u_sync/ab_count_reg[4]} {u_sync/ab_count_reg[5]} {u_sync/ab_count_reg[6]} {u_sync/ab_count_reg[7]}]]
#connect_debug_port u_ila_0/probe3 [get_nets [list {adc_data[0]} {adc_data[1]} {adc_data[2]} {adc_data[3]} {adc_data[4]} {adc_data[5]} {adc_data[6]} {adc_data[7]} {adc_data[8]} {adc_data[9]} {adc_data[10]} {adc_data[11]} {adc_data[12]} {adc_data[13]} {adc_data[14]} {adc_data[15]} {adc_data[16]} {adc_data[17]} {adc_data[18]} {adc_data[19]} {adc_data[20]} {adc_data[21]} {adc_data[22]} {adc_data[23]} {adc_data[24]} {adc_data[25]} {adc_data[26]} {adc_data[27]} {adc_data[28]} {adc_data[29]} {adc_data[30]} {adc_data[31]} {adc_data[32]} {adc_data[33]} {adc_data[34]} {adc_data[35]} {adc_data[36]} {adc_data[37]} {adc_data[38]} {adc_data[39]} {adc_data[40]} {adc_data[41]} {adc_data[42]} {adc_data[43]} {adc_data[44]} {adc_data[45]} {adc_data[46]} {adc_data[47]} {adc_data[48]} {adc_data[49]} {adc_data[50]} {adc_data[51]} {adc_data[52]} {adc_data[53]} {adc_data[54]} {adc_data[55]} {adc_data[56]} {adc_data[57]} {adc_data[58]} {adc_data[59]} {adc_data[60]} {adc_data[61]} {adc_data[62]} {adc_data[63]} {adc_data[64]} {adc_data[65]} {adc_data[66]} {adc_data[67]} {adc_data[68]} {adc_data[69]} {adc_data[70]} {adc_data[71]} {adc_data[72]} {adc_data[73]} {adc_data[74]} {adc_data[75]} {adc_data[76]} {adc_data[77]} {adc_data[78]} {adc_data[79]}]]
#connect_debug_port dbg_hub/clk [get_nets xadc_dclk_OBUF_BUFG]
...
set_property PACKAGE_PIN U13 [get_ports {digital_inputs_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[1]}]
set_property PACKAGE_PIN V13 [get_ports {digital_inputs_0[1]}]
set_property PACKAGE_PIN V15 [get_ports {digital_inputs_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[2]}]
set_property PACKAGE_PIN T15 [get_ports {digital_inputs_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[3]}]
set_property PACKAGE_PIN R16 [get_ports {digital_inputs_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[4]}]
set_property PACKAGE_PIN U17 [get_ports {digital_inputs_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[5]}]
set_property PACKAGE_PIN V17 [get_ports {digital_inputs_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[6]}]
set_property PACKAGE_PIN V18 [get_ports {digital_inputs_0[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digital_inputs_0[7]}]
set_property PACKAGE_PIN P18 [get_ports CAN0_PHY_TX_0]
set_property IOSTANDARD LVCMOS33 [get_ports CAN0_PHY_TX_0]
set_property PACKAGE_PIN N17 [get_ports CAN0_PHY_RX_0]
...
#et_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
